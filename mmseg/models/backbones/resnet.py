...
class ResNet(BaseModule):
    ...
    def forward(self, x, no_pos_embed=False, avg_pos_emd=False, duplicate_pos_emd=False, 
            use_fps=False, use_fdrop=False, DW_aux_heads=False, unconfident_attn_weight=False, 
            attn_mask=None, unconfident_attn_weight_bool=False,
            unconfident_attn_weight_bool_v2=False, attn_mask_weight=0.0,
            dynamic_attn_mask=False, ablate_attn_mask=None, ):
        """Forward function."""
        if self.deep_stem:
            x = self.stem(x)
        else:
