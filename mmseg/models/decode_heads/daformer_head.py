...
class DAFormerHead(BaseDecodeHead):
    ...
    def forward(self, inputs, PatchMix_N=0, PatchMixIndex=None, return_last_feat=False):
        ...
        for i in self.in_index:
            ...
            if PatchMix_N != 0:
                n, c, h, w = _c[i].shape
                feat_repatchmix = self._repatchmix_inputs(_c[i].view(n, c, -1).permute(0,2,1), PatchMix_N, PatchMixIndex, scale=4/(2**i))
                _c[i] = feat_repatchmix.permute(0,2,1).view(n, c, h, w)
